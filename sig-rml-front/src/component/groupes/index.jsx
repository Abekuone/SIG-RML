...
export default function IndexGroupe() {
    ...
    const data = [
        { id: 1, Libelle: "Etudiant", Description: "Les utilisateurs sont des etudiants" },
        { id: 2, Libelle: "Admin", Description: "Les utilisateurs sont des administrateurs" },
        { id: 3, Libelle: "Enseignant-Chercheur", Description: "Les utilisateurs sont des enseignants chercheurs" }
      ];
